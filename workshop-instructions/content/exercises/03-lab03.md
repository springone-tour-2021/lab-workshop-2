...
```execute-2
cd blueorgreenservice && ./mvnw spring-boot:build-image
```
...
```
blueorgreenservice         0.0.1-SNAPSHOT               adafa746205d   41 years ago    288MB
```
...
```execute-2
pack inspect blueorgreenservice:0.0.1-SNAPSHOT
```
...
```execute-2
pack inspect blueorgreenservice:0.0.1-SNAPSHOT --bom
```

You can also inspect the images using a tool called `dive`. 

```execute-1
dive blueorgreenservice::0.0.1-SNAPSHOT
```
...
```execute-1
cd authgateway && ./mvnw spring-boot:build-image
cd blueorgreenfrontend && ./mvnw spring-boot:build-image
cd blueorgreengateway && ./mvnw spring-boot:build-image
```
...
blueorgreenfrontend        0.0.1-SNAPSHOT               edb691597d36   41 years ago    317MB
authgateway                0.0.1-SNAPSHOT               81d9a9bf36c3   41 years ago    320MB
blueorgreengateway         0.0.1-SNAPSHOT               d3b4256e51c1   41 years ago    320MB
blueorgreenservice         0.0.1-SNAPSHOT               87c13f6f548a   41 years ago    317MB
```
