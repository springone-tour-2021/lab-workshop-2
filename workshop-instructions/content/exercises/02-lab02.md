...
=======
>>>>>>> 65b8adafa88e41d4e1154a9731c41d08fc30dd3b
 ```dashboard:reload-dashboard
 name: AuthGateway
 ```

<<<<<<< HEAD
Note: To reload a dashboard, you can also right click on the dashboard screen and select `Reload Frame` as shown in the following image.
...
You should see that `red` appears after a single second delay every time slow green would otherwise be called.
 ...
 ```execute-1
#http :8080/actuator/shutdown
kill $AUTHGW_PID
http :8383/actuator/shutdown
http :9090/actuator/shutdown
http :8181/actuator/shutdown
http :7070/actuator/shutdown
http :8282/actuator/shutdown
http :6060/actuator/shutdown
http :8761/actuator/shutdown
http :8888/actuator/shutdown
```
