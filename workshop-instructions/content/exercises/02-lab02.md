...
Once Eureka has started, you can access its dashboard in your browser:
```dashboard:open-url
   url: https://{{ session_namespace }}-eureka.{{ ingress_domain }}/
```
...
```dashboard:open-url
   url: https://{{ session_namespace }}-authgateway.{{ ingress_domain }}/
```
...
```dashboard:open-url
   url: https://{{ session_namespace }}-authgateway.{{ ingress_domain }}/logout
```
