...
```execute-1
mkdir -p logs
nohup spring cloud configserver eureka > logs/run-spring-cloud-cli.log 2>&1 </dev/null &
```

Run the following command repeatedly until you see output confirming that Config Server and Eureka have started.
```execute-1
grep "started on port" logs/run-spring-cloud-cli.log
```
...
```execute-1
cd blueorgreenservice && ./mvnw package -DskipTests > ../logs/build-blueorgreenservice.log 2>&1 </dev/null && \
nohup java -Xmx128M -Dspring.profiles.active=blue -jar target/blueorgreen-0.0.1-SNAPSHOT.jar > ../logs/run-blue.log 2>&1 </dev/null &
```
...
```execute-1
cd blueorgreenservice && nohup java -Xmx128M -Dspring.profiles.active=green -jar target/blueorgreen-0.0.1-SNAPSHOT.jar > ../logs/run-green.log 2>&1 </dev/null &

cd blueorgreenservice && nohup java -Xmx128M -Dspring.profiles.active=slowgreen -jar target/blueorgreen-0.0.1-SNAPSHOT.jar > ../logs/run-slowgreen.log 2>&1 </dev/null &

cd blueorgreenservice && nohup java -Xmx128M -Dspring.profiles.active=yellow -jar target/blueorgreen-0.0.1-SNAPSHOT.jar > ../logs/run-yellow.log 2>&1 </dev/null &
```
...
```execute-1
cd blueorgreenfrontend && ./mvnw package -DskipTests > ../logs/build-blueorgreenfrontend.log 2>&1 </dev/null && \
nohup java -Xmx128M -Dspring.profiles.active=local -jar target/blueorgreenfrontend-0.0.1-SNAPSHOT.jar > ../logs/run-blueorgreenfrontend.log 2>&1 </dev/null &

cd blueorgreengateway && ./mvnw package -DskipTests > ../logs/build-blueorgreengateway.log 2>&1 </dev/null && \
nohup java -Xmx128M -jar target/blueorgreengateway-0.0.1-SNAPSHOT.jar > ../logs/run-blueorgreengateway.log 2>&1 </dev/null &

cd authgateway && ./mvnw package -DskipTests > ../logs/build-authgateway.log 2>&1 </dev/null && \
nohup java -Xmx128M -jar target/authgateway-0.0.1-SNAPSHOT.jar > ../logs/run-authgateway.log 2>&1 </dev/null &
```
