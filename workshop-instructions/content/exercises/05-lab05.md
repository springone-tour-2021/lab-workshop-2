...
file: ~/color-app/blueorgreenservice/src/main/resources/application.properties
text: localhost:8888
```
...
```execute-1
for i in */src/main/resources/application.properties; do \
    sed -i s/http:\/\/localhost:8888/${CONFIG_SERVER_URI}
done
```
